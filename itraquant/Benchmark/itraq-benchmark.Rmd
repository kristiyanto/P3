...
To put in contrast, the data aboved is merged with the data from PNNL. `iTRAQ4.114 - iTRAQ4.117` indicates results from P3, while `Ion_114 - Ion_117` indicate results from PNNL.
