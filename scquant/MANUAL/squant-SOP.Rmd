...
header-includes:
  ...
  \rhead{\includegraphics[width = .2\textwidth]{pnnllogo.png}}
...
This document discuss the ```kristiyanto/p3:scquant``` container, a spectrum count quantification pipeline for label-free mass spectrometry protein quantification. The pipeline is based on MSnID pipeline [@msnid].
